/**
 * NOTE: this is a manual edit of the paper.d.ts file for the
 * "Coding Collages / Collaging Code" seminar at HfG Karlsruhe. We renamed the
 * paper namespace because it clashes with the global paper object und expose
